...
public class WorklightStandBlockEntityRenderer implements BlockEntityRenderer<WorklightStandBlockEntity> {
    ...
    @Override
    public void render(@NotNull WorklightStandBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        poseStack.pushPose();
    ...
    @Override
    public boolean shouldRenderOffScreen(@NotNull WorklightStandBlockEntity blockEntity) {
        return true;
    }

    @SuppressWarnings("unused")
    public @NotNull AABB getRenderBoundingBox(@NotNull WorklightStandBlockEntity blockEntity) {
