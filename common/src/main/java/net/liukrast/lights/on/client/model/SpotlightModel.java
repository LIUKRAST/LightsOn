...
public class SpotlightModel extends BlockEntityModel<Spotlight> {
    ...
    public static LayerDefinition create() {
        ...
        PartDefinition main = partdefinition.addOrReplaceChild("main", CubeListBuilder.create().texOffs(0, 37).addBox(-5.0F, 7.0F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 16.0F, 0.0F));
        ...
        PartDefinition body = main.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 28).addBox(-4.0F, -6.0F, -1.5F, 8.0F, 6.0F, 3.0F, new CubeDeformation(0.01F))
                .texOffs(0, 20).addBox(-5.0F, -10.0F, -2.0F, 10.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.0F, 0.0F));
