...
public abstract class BlockNetSetting<T> {
     ...
     *                See an example in {@link net.liukrast.lib.blocknet.setting.RangedBlockNetSetting}
     ...
     * An example can be seen in {@link net.liukrast.lib.blocknet.setting.RangedBlockNetSetting}
     * @since 1.0
     * @author LiukRast
     * */
